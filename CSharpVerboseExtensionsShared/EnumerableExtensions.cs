...
namespace CSharpVerboseExtensionsNetFramework
{
    public static class EnumerableExtensions
    {
        ...
        {
            return IsEnumNotEmpty<T>(sequence) ? action(sequence) : new TRet[] { };
        }
        ...
        public static IEnumerable<TItem> ForEachItem<TItem>(this IEnumerable<TItem> sequence, System.Action<TItem> action)
        {
